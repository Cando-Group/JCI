<?php
    ...
    $reqComDirecteurNational = $database->prepare("SELECT * FROM institutionnationale ORDER BY id DESC ");
...
<div class="content-wrapper-scroll">
    ...
    <div class="row gx-3">
        ...
        <h3 class="text-danger">Liste des membres de l'Institution Nationale</h3>
        ...
        <?php
            ...
            while ($dataComDirectNational = $reqComDirecteurNational->fetch()){
                ...
                $entite = $dataComDirectNational['entite'];
