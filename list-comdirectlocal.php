<?php
    ...
    $reqComDirecteurNational = $database->prepare("SELECT * FROM comitedirecteurlocal ORDER BY id DESC ");
...
<div class="content-wrapper-scroll">
    ...
    <div class="row gx-3">
        ...
        <h3 class="text-danger">Liste des membres du Comité Directeur Local</h3>
