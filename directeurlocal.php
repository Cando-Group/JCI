<?php
    ...
    if (isset($_POST['update'])){
        ...
        if (!empty($_POST['poste'])){
            ...
            $reqComiteDirecteurNational = $database->prepare("SELECT * FROM comitedirecteurlocal WHERE id_membre=:id_membre");
            ...
            if ($countComiteDirecteurNational === 0){
                ...
                $updateDirecteurNationale = $database->prepare("INSERT INTO comitedirecteurlocal(id_membre, poste, service) VALUES(:id_membre, :poste, :service)");
...
<div class="content-wrapper-scroll">
    ...
    <h2 class="text-danger">COMITE DIRECTEUR LOCAL</h2>
        <?php
            ...
            if ($countDirecteurNationale != 0){
                ...
                $reqAjout = $database->prepare("SELECT * FROM comitedirecteurlocal WHERE id_membre=:id_membre");
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form method="post">
                                        ...
                                        <select name="poste" id="" class="form-control" required>
                                            ...
                                            <option value="Président Local - PL">Président Local - PL</option>
                                            ...
                                            <option value="Vice-Président Exécutif">Vice-Président Exécutif  </option>
                                            <option value="Secrétaire Général">Secrétaire Général</option>
                                            <option value="Trésorier Général">Trésorier Général</option>
                                            <option value="Conseiller Juridique">Conseiller Juridique</option>
                                        </select>
