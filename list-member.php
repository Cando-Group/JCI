        ...
        <div class="content-wrapper-scroll">
          ...
          <div class="content-wrapper">
            ...
            <div class="row gx-3">
                ...
                <h3>Liste des membres de la JCI</h3>
                                ...
                                while ($dataUsers = $reqUsers->fetch()){
                                    ...
                                    if ($categorie === "Membre" ){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    if ($dataUsers['categorie'] === "Postulant"){
                                                        ?>
                                                        <a href="" class="btn btn-success">Mise à jour en membre</a>
                                                        <?php
                                                    }
                                                ?>
                                            </td>
                                            <td>
                                                <a href="ajout?type=modif&id=<?=$dataUsers['id']?>" class="btn btn-success">
